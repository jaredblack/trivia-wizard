...
<main class="container">
	...
	{:else}
		<div>
			...
			<Timer bind:duration={timerDuration} {updateAcceptingAnswers} bind:this={timerElement} />
			<h3>Answers</h3>
			...
			{:else}
				{#each answerList as answer}
					<Answer
                        ...
                        {questionPoints}
                        bind:multiScoring={multiScoring}
					/>
				{/each}
			{/if}
		</div>
        <div class="footer">
            ...
            <label for="questionPoints" class="numberInputLabel"
                >Question points
                <input type="number" id="questionPoints" bind:value={questionPoints} class="smallNumInput" />
            </label>
            <fieldset>
                <label for="multiScoreSwitch"
                    >Multi-scoring
                    <input type="checkbox" role="switch" id="multiScoreSwitch" bind:checked={multiScoring}/>
                </label>
            </fieldset>
        </div>
	{/if}
